...
--
-- Dumping data for table `main_pa_groups`
--

LOCK TABLES `main_pa_groups` WRITE;
/*!40000 ALTER TABLE `main_pa_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_groups` ENABLE KEYS */;
UNLOCK TABLES;
