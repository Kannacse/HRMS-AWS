...
--
-- Table structure for table `tds_form_report`
--

DROP TABLE IF EXISTS `tds_form_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tds_form_report` (
  ...
  `previous_income_after_excemptions_inp` int NOT NULL DEFAULT '0',
  `previous_employment_gtotal` int NOT NULL DEFAULT '0',
  `previous_employment_total` int NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `tds_form_report`
--

LOCK TABLES `tds_form_report` WRITE;
/*!40000 ALTER TABLE `tds_form_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `tds_form_report` ENABLE KEYS */;
UNLOCK TABLES;
