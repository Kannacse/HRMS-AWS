...
CREATE TABLE `main_bgchecks_summary` (
  ...
  `specimen_id` bigint unsigned DEFAULT NULL,
  ...
  `screeningtypeid` bigint unsigned DEFAULT NULL,
  `screeningtype_name` varchar(200) DEFAULT NULL,
  `agencyid` bigint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_bgchecks_summary`
--

LOCK TABLES `main_bgchecks_summary` WRITE;
/*!40000 ALTER TABLE `main_bgchecks_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_bgchecks_summary` ENABLE KEYS */;
UNLOCK TABLES;
