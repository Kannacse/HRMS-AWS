...
--
-- Dumping data for table `main_empworkdetails`
--

LOCK TABLES `main_empworkdetails` WRITE;
/*!40000 ALTER TABLE `main_empworkdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empworkdetails` ENABLE KEYS */;
UNLOCK TABLES;
