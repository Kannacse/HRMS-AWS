...
--
-- Dumping data for table `expense_receipts`
--

LOCK TABLES `expense_receipts` WRITE;
/*!40000 ALTER TABLE `expense_receipts` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_receipts` ENABLE KEYS */;
UNLOCK TABLES;
