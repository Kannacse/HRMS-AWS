...
--
-- Dumping data for table `tm_ts_status`
--

LOCK TABLES `tm_ts_status` WRITE;
/*!40000 ALTER TABLE `tm_ts_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `tm_ts_status` ENABLE KEYS */;
UNLOCK TABLES;
