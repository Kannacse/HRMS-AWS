...
--
-- Dumping data for table `main_emp_reporting`
--

LOCK TABLES `main_emp_reporting` WRITE;
/*!40000 ALTER TABLE `main_emp_reporting` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_emp_reporting` ENABLE KEYS */;
UNLOCK TABLES;
