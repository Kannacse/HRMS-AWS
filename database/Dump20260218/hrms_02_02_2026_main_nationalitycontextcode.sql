...
--
-- Dumping data for table `main_nationalitycontextcode`
--

LOCK TABLES `main_nationalitycontextcode` WRITE;
/*!40000 ALTER TABLE `main_nationalitycontextcode` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_nationalitycontextcode` ENABLE KEYS */;
UNLOCK TABLES;
