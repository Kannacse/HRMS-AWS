...
--
-- Dumping data for table `main_militaryservice`
--

LOCK TABLES `main_militaryservice` WRITE;
/*!40000 ALTER TABLE `main_militaryservice` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_militaryservice` ENABLE KEYS */;
UNLOCK TABLES;
