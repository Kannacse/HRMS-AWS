...
--
-- Dumping data for table `main_empcreditcarddetails`
--

LOCK TABLES `main_empcreditcarddetails` WRITE;
/*!40000 ALTER TABLE `main_empcreditcarddetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empcreditcarddetails` ENABLE KEYS */;
UNLOCK TABLES;
