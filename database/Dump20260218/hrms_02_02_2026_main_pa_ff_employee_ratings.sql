...
CREATE TABLE `main_pa_ff_employee_ratings` (
  ...
  `ff_initialization_id` bigint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_pa_ff_employee_ratings`
--

LOCK TABLES `main_pa_ff_employee_ratings` WRITE;
/*!40000 ALTER TABLE `main_pa_ff_employee_ratings` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_ff_employee_ratings` ENABLE KEYS */;
UNLOCK TABLES;
