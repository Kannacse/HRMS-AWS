...
CREATE TABLE `main_pa_employee_ratings` (
  ...
  `line_manager_1` bigint DEFAULT NULL,
  `line_manager_2` bigint DEFAULT NULL,
  `line_manager_3` bigint DEFAULT NULL,
  `line_manager_4` bigint DEFAULT NULL,
  `line_manager_5` bigint DEFAULT NULL,
  ...
  `line_comment_4` text,
  `line_comment_5` text,
  `line_rating_1` int unsigned DEFAULT NULL,
  `line_rating_2` int unsigned DEFAULT NULL,
  `line_rating_3` int unsigned DEFAULT NULL,
  `line_rating_4` int DEFAULT NULL,
  `line_rating_5` int DEFAULT NULL,
...
--
-- Dumping data for table `main_pa_employee_ratings`
--

LOCK TABLES `main_pa_employee_ratings` WRITE;
/*!40000 ALTER TABLE `main_pa_employee_ratings` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_employee_ratings` ENABLE KEYS */;
UNLOCK TABLES;
