...
CREATE TABLE `main_empdependencydetails` (
  ...
  `dependent_age` int unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_empdependencydetails`
--

LOCK TABLES `main_empdependencydetails` WRITE;
/*!40000 ALTER TABLE `main_empdependencydetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empdependencydetails` ENABLE KEYS */;
UNLOCK TABLES;
