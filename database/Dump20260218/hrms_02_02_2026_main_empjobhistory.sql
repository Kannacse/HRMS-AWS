...
CREATE TABLE `main_empjobhistory` (
  ...
  `positionheld` int unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_empjobhistory`
--

LOCK TABLES `main_empjobhistory` WRITE;
/*!40000 ALTER TABLE `main_empjobhistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empjobhistory` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-02-18 14:58:26
