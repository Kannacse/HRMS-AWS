...
--
-- Dumping data for table `expense_advacne_summary`
--

LOCK TABLES `expense_advacne_summary` WRITE;
/*!40000 ALTER TABLE `expense_advacne_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_advacne_summary` ENABLE KEYS */;
UNLOCK TABLES;
