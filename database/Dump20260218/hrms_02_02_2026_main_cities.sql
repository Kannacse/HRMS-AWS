...
CREATE TABLE `main_cities` (
  ...
  `city_org_id` int unsigned DEFAULT NULL,
...
LOCK TABLES `main_cities` WRITE;
/*!40000 ALTER TABLE `main_cities` DISABLE KEYS */;
INSERT INTO `main_cities` VALUES (1,100,514,'Chennai (Madras)',1027,1,1,'2019-06-14 05:10:20','2022-07-11 04:11:36',1);
/*!40000 ALTER TABLE `main_cities` ENABLE KEYS */;
UNLOCK TABLES;
