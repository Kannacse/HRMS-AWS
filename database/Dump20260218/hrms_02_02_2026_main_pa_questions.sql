...
CREATE TABLE `main_pa_questions` (
  ...
  `pa_category_id` bigint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_pa_questions`
--

LOCK TABLES `main_pa_questions` WRITE;
/*!40000 ALTER TABLE `main_pa_questions` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_questions` ENABLE KEYS */;
UNLOCK TABLES;
