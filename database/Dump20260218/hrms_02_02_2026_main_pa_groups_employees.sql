...
--
-- Dumping data for table `main_pa_groups_employees`
--

LOCK TABLES `main_pa_groups_employees` WRITE;
/*!40000 ALTER TABLE `main_pa_groups_employees` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_groups_employees` ENABLE KEYS */;
UNLOCK TABLES;
