...
--
-- Dumping data for table `expense_notifications`
--

LOCK TABLES `expense_notifications` WRITE;
/*!40000 ALTER TABLE `expense_notifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_notifications` ENABLE KEYS */;
UNLOCK TABLES;
