...
--
-- Dumping data for table `main_empdisabilitydetails`
--

LOCK TABLES `main_empdisabilitydetails` WRITE;
/*!40000 ALTER TABLE `main_empdisabilitydetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empdisabilitydetails` ENABLE KEYS */;
UNLOCK TABLES;
