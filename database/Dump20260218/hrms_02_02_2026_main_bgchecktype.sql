...
--
-- Dumping data for table `main_bgchecktype`
--

LOCK TABLES `main_bgchecktype` WRITE;
/*!40000 ALTER TABLE `main_bgchecktype` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_bgchecktype` ENABLE KEYS */;
UNLOCK TABLES;
