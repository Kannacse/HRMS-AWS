...
CREATE TABLE `main_bgcheckcomments` (
  ...
  `bgdet_id` int unsigned DEFAULT NULL,
  `comment` text,
...
--
-- Dumping data for table `main_bgcheckcomments`
--

LOCK TABLES `main_bgcheckcomments` WRITE;
/*!40000 ALTER TABLE `main_bgcheckcomments` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_bgcheckcomments` ENABLE KEYS */;
UNLOCK TABLES;
