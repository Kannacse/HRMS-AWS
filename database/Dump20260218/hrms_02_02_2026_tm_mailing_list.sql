...
CREATE TABLE `tm_mailing_list` (
  ...
  `mail_content` text,
  `is_mail_sent` tinyint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `tm_mailing_list`
--

LOCK TABLES `tm_mailing_list` WRITE;
/*!40000 ALTER TABLE `tm_mailing_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `tm_mailing_list` ENABLE KEYS */;
UNLOCK TABLES;
