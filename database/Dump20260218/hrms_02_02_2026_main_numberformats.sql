...
--
-- Dumping data for table `main_numberformats`
--

LOCK TABLES `main_numberformats` WRITE;
/*!40000 ALTER TABLE `main_numberformats` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_numberformats` ENABLE KEYS */;
UNLOCK TABLES;
