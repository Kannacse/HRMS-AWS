...
--
-- Dumping data for table `main_bgcheckdetails`
--

LOCK TABLES `main_bgcheckdetails` WRITE;
/*!40000 ALTER TABLE `main_bgcheckdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_bgcheckdetails` ENABLE KEYS */;
UNLOCK TABLES;
