...
--
-- Dumping data for table `main_disciplinary_violation_types`
--

LOCK TABLES `main_disciplinary_violation_types` WRITE;
/*!40000 ALTER TABLE `main_disciplinary_violation_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_disciplinary_violation_types` ENABLE KEYS */;
UNLOCK TABLES;
