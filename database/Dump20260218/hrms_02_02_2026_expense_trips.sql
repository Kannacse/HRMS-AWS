...
--
-- Dumping data for table `expense_trips`
--

LOCK TABLES `expense_trips` WRITE;
/*!40000 ALTER TABLE `expense_trips` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_trips` ENABLE KEYS */;
UNLOCK TABLES;
