...
--
-- Dumping data for table `main_eeoccategory`
--

LOCK TABLES `main_eeoccategory` WRITE;
/*!40000 ALTER TABLE `main_eeoccategory` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_eeoccategory` ENABLE KEYS */;
UNLOCK TABLES;
