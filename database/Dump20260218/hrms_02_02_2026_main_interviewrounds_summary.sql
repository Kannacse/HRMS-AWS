...
CREATE TABLE `main_interviewrounds_summary` (
  ...
  `interviewround_id` int unsigned DEFAULT NULL,
  ...
  `interview_round_number` int unsigned DEFAULT NULL,
  `interview_round_name` varchar(200) DEFAULT NULL,
  `interview_location` varchar(200) DEFAULT NULL,
  `interview_city_id` int unsigned DEFAULT NULL,
  `interview_state_id` int unsigned DEFAULT NULL,
  `interview_city_name` varchar(255) DEFAULT NULL,
  `interview_state_name` varchar(255) DEFAULT NULL,
  `interview_country_id` int unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_interviewrounds_summary`
--

LOCK TABLES `main_interviewrounds_summary` WRITE;
/*!40000 ALTER TABLE `main_interviewrounds_summary` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_interviewrounds_summary` ENABLE KEYS */;
UNLOCK TABLES;
