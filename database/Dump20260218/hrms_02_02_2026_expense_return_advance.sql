...
--
-- Dumping data for table `expense_return_advance`
--

LOCK TABLES `expense_return_advance` WRITE;
/*!40000 ALTER TABLE `expense_return_advance` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_return_advance` ENABLE KEYS */;
UNLOCK TABLES;
