...
--
-- Dumping data for table `main_empvisadetails`
--

LOCK TABLES `main_empvisadetails` WRITE;
/*!40000 ALTER TABLE `main_empvisadetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empvisadetails` ENABLE KEYS */;
UNLOCK TABLES;
