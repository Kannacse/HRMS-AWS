...
CREATE TABLE `main_pa_questions_privileges` (
  ...
  `employee_id` bigint unsigned DEFAULT NULL COMMENT 'Null for feedforward else employee id',
  ...
  `manager_group_id` bigint unsigned DEFAULT NULL COMMENT 'group id of employees created by manager',
  ...
  `line_manager_1` bigint DEFAULT NULL COMMENT 'Line 1 manager id',
  `line_manager_2` bigint DEFAULT NULL COMMENT 'Line 2 manager id',
  `line_manager_3` bigint DEFAULT NULL COMMENT 'Line 3 manager id',
  `line_manager_4` bigint DEFAULT NULL COMMENT 'Line 4 manager id',
  `line_manager_5` bigint DEFAULT NULL COMMENT 'Line 5 manager id',
...
--
-- Dumping data for table `main_pa_questions_privileges`
--

LOCK TABLES `main_pa_questions_privileges` WRITE;
/*!40000 ALTER TABLE `main_pa_questions_privileges` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_questions_privileges` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-02-18 14:59:51
