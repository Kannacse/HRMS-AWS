...
--
-- Dumping data for table `main_veteranstatus`
--

LOCK TABLES `main_veteranstatus` WRITE;
/*!40000 ALTER TABLE `main_veteranstatus` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_veteranstatus` ENABLE KEYS */;
UNLOCK TABLES;
