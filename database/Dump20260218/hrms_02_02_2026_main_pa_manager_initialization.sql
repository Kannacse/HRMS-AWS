...
CREATE TABLE `main_pa_manager_initialization` (
  ...
  `approver_level` bigint unsigned DEFAULT NULL,
  `approver_1_id` bigint unsigned DEFAULT NULL,
  `approver_2_id` bigint unsigned DEFAULT NULL,
  `approver_3_id` bigint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_pa_manager_initialization`
--

LOCK TABLES `main_pa_manager_initialization` WRITE;
/*!40000 ALTER TABLE `main_pa_manager_initialization` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_manager_initialization` ENABLE KEYS */;
UNLOCK TABLES;
