...
CREATE TABLE `tm_project_tasks` (
  ...
  `estimated_hrs` mediumint unsigned DEFAULT NULL,
...
--
-- Dumping data for table `tm_project_tasks`
--

LOCK TABLES `tm_project_tasks` WRITE;
/*!40000 ALTER TABLE `tm_project_tasks` DISABLE KEYS */;
/*!40000 ALTER TABLE `tm_project_tasks` ENABLE KEYS */;
UNLOCK TABLES;
