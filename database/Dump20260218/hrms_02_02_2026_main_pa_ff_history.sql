...
CREATE TABLE `main_pa_ff_history` (
  ...
  `pa_ff_initialization_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `main_pa_ff_history`
--

LOCK TABLES `main_pa_ff_history` WRITE;
/*!40000 ALTER TABLE `main_pa_ff_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_ff_history` ENABLE KEYS */;
UNLOCK TABLES;
