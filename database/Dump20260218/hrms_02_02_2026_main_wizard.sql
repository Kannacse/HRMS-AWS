...
--
-- Dumping data for table `main_wizard`
--

LOCK TABLES `main_wizard` WRITE;
/*!40000 ALTER TABLE `main_wizard` DISABLE KEYS */;
INSERT INTO `main_wizard` VALUES (1,1,2,2,2,2,100,514,1027,2,1,187,'2022-07-11 04:11:36','2024-06-06 07:21:07',1);
/*!40000 ALTER TABLE `main_wizard` ENABLE KEYS */;
UNLOCK TABLES;
