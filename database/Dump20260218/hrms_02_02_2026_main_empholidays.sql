...
CREATE TABLE `main_empholidays` (
  ...
  `holiday_group_id` int unsigned DEFAULT NULL,
...
--
-- Dumping data for table `main_empholidays`
--

LOCK TABLES `main_empholidays` WRITE;
/*!40000 ALTER TABLE `main_empholidays` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empholidays` ENABLE KEYS */;
UNLOCK TABLES;
