...
CREATE TABLE `main_allottedleaveslog` (
  ...
  `assignedleaves` int DEFAULT NULL,
...
LOCK TABLES `main_allottedleaveslog` WRITE;
/*!40000 ALTER TABLE `main_allottedleaveslog` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_allottedleaveslog` ENABLE KEYS */;
UNLOCK TABLES;
