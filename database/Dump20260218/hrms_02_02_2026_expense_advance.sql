...
--
-- Dumping data for table `expense_advance`
--

LOCK TABLES `expense_advance` WRITE;
/*!40000 ALTER TABLE `expense_advance` DISABLE KEYS */;
/*!40000 ALTER TABLE `expense_advance` ENABLE KEYS */;
UNLOCK TABLES;
