...
--
-- Dumping data for table `main_hierarchylevels`
--

LOCK TABLES `main_hierarchylevels` WRITE;
/*!40000 ALTER TABLE `main_hierarchylevels` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_hierarchylevels` ENABLE KEYS */;
UNLOCK TABLES;
