...
--
-- Dumping data for table `main_pa_groups_employees_temp`
--

LOCK TABLES `main_pa_groups_employees_temp` WRITE;
/*!40000 ALTER TABLE `main_pa_groups_employees_temp` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pa_groups_employees_temp` ENABLE KEYS */;
UNLOCK TABLES;
