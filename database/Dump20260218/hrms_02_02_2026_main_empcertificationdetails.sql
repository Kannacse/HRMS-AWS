...
--
-- Dumping data for table `main_empcertificationdetails`
--

LOCK TABLES `main_empcertificationdetails` WRITE;
/*!40000 ALTER TABLE `main_empcertificationdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_empcertificationdetails` ENABLE KEYS */;
UNLOCK TABLES;
