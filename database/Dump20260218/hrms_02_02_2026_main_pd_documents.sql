...
CREATE TABLE `main_pd_documents` (
  ...
  `subcategory_id` bigint unsigned DEFAULT NULL COMMENT 'not used ',
...
--
-- Dumping data for table `main_pd_documents`
--

LOCK TABLES `main_pd_documents` WRITE;
/*!40000 ALTER TABLE `main_pd_documents` DISABLE KEYS */;
/*!40000 ALTER TABLE `main_pd_documents` ENABLE KEYS */;
UNLOCK TABLES;
